...
interface EditFormProps {
  fid: { id: string; name: string; price: number; category: string };
  closeEvent: () => void;
}

const EditForm: React.FC<EditFormProps> = ({ fid, closeEvent }) => {
  ...
  // Uncomment the following code after implementing Firebase logic
  // const createUser = async () => {
  //   // Firebase logic here
  //   getUsers();
  //   closeEvent();
